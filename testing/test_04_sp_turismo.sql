...
BEGIN TRY
    ...
    EXEC SP_AltaTipoVisitante @Descripcion = 'Jubilado Test', @Descuento = 20;
    ...
    BEGIN TRY
        EXEC SP_AltaTipoVisitante @Descripcion = 'Jubilado Test', @Descuento = 10;
    ...
    BEGIN TRY
        EXEC SP_AltaTipoVisitante @Descripcion = 'Estudiante Test', @Descuento = 150;
    ...
    EXEC SP_ModificacionTipoVisitante @IdTipoVisitante = @idTipoVisitanteTest1, @Descuento = 25;
    ...
    BEGIN TRY
        EXEC SP_ModificacionTipoVisitante @IdTipoVisitante = -1, @Descuento = 5;
    ...
    EXEC SP_AltaTipoVisitante @Descripcion = 'Estudiante Test 6', @Descuento = 15;
    ...
    BEGIN TRY
        EXEC SP_ModificacionTipoVisitante @IdTipoVisitante = @idTipoVisitanteTest6, @Descripcion = 'Jubilado Test';
    ...
    ----------------------------------------
    -- SP_BajaTipoVisitante
    ----------------------------------------

    -- Test 7: baja de un IdTipoVisitante inexistente.
    -- Resultado esperado: error 50000 "El tipo de visitante no existe."
    BEGIN TRY
        EXEC SP_BajaTipoVisitante @IdTipoVisitante = -1;
    ...
    EXEC SP_BajaTipoVisitante @IdTipoVisitante = @idTipoVisitanteTest6;
    ...
    BEGIN TRY
        EXEC SP_BajaTipoVisitante @IdTipoVisitante = @idTipoVisitanteTest1;
    ...
    BEGIN TRY
        EXEC SP_BajaVisitante @IdVisitante = -1;
    ...
    -- Resultado esperado: se elimina sin error.
    EXEC SP_BajaVisitante @IdVisitante = @idVisitanteTest19;

    -- Setup para Test 22: una venta asociada al visitante del Test 10, para
    -- forzar la validación de "tiene ventas asociadas" de SP_BajaVisitante.
    ...
    BEGIN TRY
        EXEC SP_BajaVisitante @IdVisitante = @idVisitanteTest10;
    ...
    EXEC SP_AltaTurno @IdActividad = @idActividadTurnoSetup, @HoraInicio = '10:00', @HoraFin = '12:00', @DiaDeSemana = 2;
    ...
    BEGIN TRY
        EXEC SP_AltaTurno @IdActividad = -1, @HoraInicio = '10:00', @HoraFin = '12:00', @DiaDeSemana = 2;
    ...
    BEGIN TRY
        EXEC SP_AltaTurno @IdActividad = @idActividadTurnoSetup, @HoraInicio = '10:00', @HoraFin = '12:00', @DiaDeSemana = 8;
    ...
    EXEC SP_ModificacionTurno @IdTurno = @idTurnoTest23, @HoraInicio = '11:00';
    ...
    BEGIN TRY
        EXEC SP_ModificacionTurno @IdTurno = -1, @HoraInicio = '11:00';
    ...
    BEGIN
        ...
        VALUES ('Cabalgata Test Turno', 'Tour', 500.00, 90, 10, @idParqueSetup);
        SET @idActividadTurnoSetup = SCOPE_IDENTITY();
        PRINT 'Nota: transaccion danada por bug de SP_ModificacionTurno (Test 27) recuperada.';
    END
    ...
    BEGIN
        ...
        SET XACT_ABORT OFF;
        SET @idTurnoTest23 = IDENT_CURRENT('Turismo.Turno');
        PRINT 'Nota: transaccion danada por bug de SP_BajaTurno (Test 28) recuperada.';
    END

    -- Test 29: baja exitosa.
    -- Resultado esperado: se elimina sin error.
    EXEC SP_BajaTurno @IdTurno = @idTurnoTest23;
    SET XACT_ABORT OFF;
    ...
    EXEC SP_AltaActividad @Nombre = 'Sendero Test Turismo', @Costo = 100.00, @DuracionMinutos = 60, @Tipo = 'Atracción', @CupoMaximo = 15, @IdParque = @idParqueSetup;
    ...
    BEGIN TRY
        EXEC SP_AltaActividad @Nombre = 'Actividad Sin Parque', @Costo = 100.00, @DuracionMinutos = 60, @Tipo = 'Tour', @CupoMaximo = 10, @IdParque = -1;
    ...
    BEGIN TRY
        EXEC SP_AltaActividad @Nombre = 'Sendero Test Turismo', @Costo = 200.00, @DuracionMinutos = 30, @Tipo = 'Tour', @CupoMaximo = 5, @IdParque = @idParqueSetup;
    ...
    BEGIN TRY
        EXEC SP_AltaActividad @Nombre = 'Actividad Tipo Invalido', @Costo = 100.00, @DuracionMinutos = 60, @Tipo = 'Paseo', @CupoMaximo = 10, @IdParque = @idParqueSetup;
    ...
    BEGIN TRY
        EXEC SP_AltaActividad @Nombre = 'Actividad Costo Invalido', @Costo = -1.00, @DuracionMinutos = 60, @Tipo = 'Tour', @CupoMaximo = 10, @IdParque = @idParqueSetup;
    ...
    BEGIN TRY
        EXEC SP_AltaActividad @Nombre = 'Actividad Duracion Invalida', @Costo = 100.00, @DuracionMinutos = 0, @Tipo = 'Tour', @CupoMaximo = 10, @IdParque = @idParqueSetup;
    ...
    BEGIN TRY
        EXEC SP_AltaActividad @Nombre = 'Actividad Cupo Invalido', @Costo = 100.00, @DuracionMinutos = 60, @Tipo = 'Tour', @CupoMaximo = 0, @IdParque = @idParqueSetup;
    ...
    EXEC SP_ModificacionActividad @IdActividad = @idActividadTest30, @Costo = 150.00;
    ...
    BEGIN TRY
        EXEC SP_ModificacionActividad @IdActividad = -1, @Costo = 999.00;
    ...
    BEGIN TRY
        EXEC SP_BajaActividad @IdActividad = -1;
    ...
    EXEC SP_AltaActividad @Nombre = 'Avistaje Test Turismo', @Costo = 80.00, @DuracionMinutos = 45, @Tipo = 'Tour', @CupoMaximo = 8, @IdParque = @idParqueSetup;
    SET @idActividadTest40 = IDENT_CURRENT('Turismo.Actividad');

    -- Test 40: baja de una actividad sin registros relacionados.
    -- Resultado esperado: se elimina sin error.
    EXEC SP_BajaActividad @IdActividad = @idActividadTest40;
    ...
    BEGIN TRY
        EXEC SP_BajaActividad @IdActividad = @idActividadTest30;
    ...
    EXEC SP_AltaEntradaParque @Costo = 500.00, @FechaAcceso = '2026-07-01', @IdParque = @idParqueSetup;
    ...
    -- Resultado esperado: error 50000 "El Parque indicado no existe".
    BEGIN TRY
        EXEC SP_AltaEntradaParque @Costo = 500.00, @FechaAcceso = '2026-07-01', @IdParque = -1;
    ...
    BEGIN TRY
        EXEC SP_AltaEntradaParque @Costo = 0.00, @FechaAcceso = '2026-07-01', @IdParque = @idParqueSetup;
    ...
    BEGIN TRY
        EXEC SP_ModificacionEntradaParque @IdEntradaParque = -1, @Costo = 700.00;
    ...
    -- Resultado esperado: error 50000 "El Parque indicado no existe".
    BEGIN TRY
        EXEC SP_ModificacionEntradaParque @IdEntradaParque = @idEntradaTest42, @IdParque = -1;
    ...
    EXEC SP_AltaEntradaParque @Costo = 300.00, @FechaAcceso = '2026-08-01', @IdParque = @idParqueSetup;
    SET @idEntradaTest49 = IDENT_CURRENT('Turismo.EntradaParque');

    -- Test 49: baja de una entrada sin líneas de venta asociadas.
    -- Resultado esperado: se elimina sin error.
    EXEC SP_BajaEntradaParque @IdEntradaParque = @idEntradaTest49;
    ...
    BEGIN TRY
        EXEC SP_BajaEntradaParque @IdEntradaParque = @idEntradaTest42;
